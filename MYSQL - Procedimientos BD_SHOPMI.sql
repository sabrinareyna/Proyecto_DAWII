...
BEGIN
	IF EXISTS (SELECT 1 FROM PRODUCTO WHERE CODPRODUCTO = CODPRODUCTO) THEN
		UPDATE PRODUCTO
		SET 
	...
	ELSE
		INSERT INTO PRODUCTO(
			CODCATEGORIA, IMGPRODUCTO, NOMPRODUCTO, DESCRIPCION, PREUNI,
...
-- DELETE
CREATE PROCEDURE USP_DELETE_PRODUCTO(IN CODPRODUCTO INT)
BEGIN
	UPDATE PRODUCTO
	SET ESTPRODUCTO = 0
	WHERE PRODUCTO.CODPRODUCTO = CODPRODUCTO;
...
-- ENABLE 
CREATE PROCEDURE USP_ENABLE_PRODUCTO(IN CODPRODUCTO INT)
BEGIN
	UPDATE PRODUCTO
	SET ESTPRODUCTO = 1
	WHERE PRODUCTO.CODPRODUCTO = CODPRODUCTO;
