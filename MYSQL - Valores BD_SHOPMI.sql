...
INSERT INTO USUARIO (NUMERODOCUMENTO, APEUSUARIO, NOMUSUARIO, FECNAC, SEXUSUARIO, TELUSUARIO, CORUSUARIO, CONUSUARIO, ESTUSUARIO, CODROL)
VALUES ('70111222', 'Pérez García', 'Juan', '1990-01-15', 'M', '987654321', 'juan.perez@mail.com', '$2a$12$ttMRz1hfmFRTbQ4J..v13O0lJHhnwFtW6HX3m6LW3AgBYTXFVDz3I', 1, 1);
INSERT INTO USUARIO (NUMERODOCUMENTO, APEUSUARIO, NOMUSUARIO, FECNAC, SEXUSUARIO, TELUSUARIO, CORUSUARIO, CONUSUARIO, ESTUSUARIO, CODROL)
VALUES ('70333444', 'López Díaz', 'María', '1995-11-30', 'F', '912345678', 'maria.lopez@mail.com', '$2a$12$ttMRz1hfmFRTbQ4J..v13O0lJHhnwFtW6HX3m6LW3AgBYTXFVDz3I', 1, 1);
select*from usuario;
/* CATEGORIA */
...
(2, '2025-06-01', 1699.97, 2, 1);
INSERT INTO PEDIDO (CODUSUARIO, FECPED, PRECIOTOTAL, CODESTADO, ESTPED) VALUES 
(3, '2025-06-05', 689.95, 3, 1);


select*from pedido;
/* DETALLEPEDIDO */
INSERT INTO DETALLEPEDIDO (CODPEDIDO, CODPRODUCTO, PREUNI, CANTIDAD) 
VALUES (1, 13, 1199.99, 1);
INSERT INTO DETALLEPEDIDO (CODPEDIDO, CODPRODUCTO, PREUNI, CANTIDAD)
VALUES (1, 25, 249.99, 2);

INSERT INTO DETALLEPEDIDO (CODPEDIDO, CODPRODUCTO, PREUNI, CANTIDAD)
VALUES (2, 3, 499.99, 1);
-- Detalle 2.2: Xiaomi Sensor de Temperatura y Humedad (ID 51)
INSERT INTO DETALLEPEDIDO (CODPEDIDO, CODPRODUCTO, PREUNI, CANTIDAD)
VALUES (2, 51, 19.99, 3);
-- Detalle 2.3: HP Sprocket (ID 64)
INSERT INTO DETALLEPEDIDO (CODPEDIDO, CODPRODUCTO, PREUNI, CANTIDAD)
VALUES (2, 64, 129.99, 1);